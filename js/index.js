...
const GoogleAds = {
  loading() {
    if (ifExistNode('.post-art') && !ifIsMobile) {
      this.$postArt = $('.post-art')
      this.$node = this.$postArt.find('.art')
      this.gjs = $('<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>')
      this.ins = $('<ins class="adsbygoogle" style="display:block; text-align:center;" data-ad-layout="in-article" data-ad-format="fluid" data-ad-client="ca-pub-9441161448418285" data-ad-slot="6860833347"></ins>')
      this.$node.html('')
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          try {
            ...
            console.log('未能加载 google ads')
          }
        }, 2000);
      }, 100);
    } else if (ifExistNode('.about-art') && !ifIsMobile) {
      this.$aboutArt = $('.about-art')
      this.$node = this.$aboutArt.find('.art')
      this.gjs = $('<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>')
      this.ins = $('<ins class="adsbygoogle" style="display:block; text-align:center;" data-ad-layout="in-article" data-ad-format="fluid" data-ad-client="ca-pub-9441161448418285" data-ad-slot="3867936552"></ins>')
      this.$node.html('')
      setTimeout(() => {
        this.$node.append(this.gjs)
        setTimeout(() => {
          ...
          try {
            (adsbygoogle = window.adsbygoogle || []).push({});
            this.$aboutArt.css({ 'display': 'block' })
          } catch {
            console.log('未能加载 google ads')
          }
        }, 2000);
